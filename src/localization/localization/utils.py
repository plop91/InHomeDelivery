...
def add_odometry_noise(odom_act, heading_sigma, trans_sigma):
    return [[add_gaussian_noise(odom_act[0][0], trans_sigma), add_gaussian_noise(odom_act[0][1], trans_sigma),
             add_gaussian_noise(odom_act[0][2], heading_sigma)],
            [add_gaussian_noise(odom_act[1][0], trans_sigma), add_gaussian_noise(odom_act[1][1], trans_sigma),
